...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    meta: [
      { title: "Shiv Rudraksh Resort · Luxury Stay by the Ganges, Varanasi" },
      {
        name: "description",
        content:
          "A premium riverside resort in Varanasi offering elegant rooms, fine dining, and spiritual serenity by the sacred Ganges.",
      },
      { property: "og:title", content: "Shiv Rudraksh Resort · Varanasi" },
      {
        property: "og:description",
        content: "Luxury stay by the Ganges — peace, comfort and timeless hospitality.",
      },
...
const experiences = [
  { name: "Ganga Aarti", img: expAarti, tag: "Spiritual" },
  { name: "Sunrise Boat Rides", img: expBoat, tag: "Heritage" },
  { name: "Rooftop Dining", img: expDining, tag: "Culinary" },
  { name: "Spiritual Retreat", img: expRetreat, tag: "Wellness" },
  { name: "Celebrations", img: expEvents, tag: "Events" },
];
    ...
    <main className="bg-background text-foreground">
      ...
      >
        <div className="absolute inset-0">
          <img
            src={heroImg}
            alt="Shiv Rudraksh Resort on the Ganges at dusk"
            width={1920}
            height={1280}
        ...
        <div className="relative z-10 px-6 text-center max-w-4xl mx-auto">
          ...
          <Reveal delay={150}>
            <h1 className="mt-8 font-display text-5xl sm:text-7xl md:text-8xl text-white leading-[1.05] text-balance">
              Shiv <em className="not-italic text-gradient-gold">Rudraksh</em> Resort
            </h1>
          </Reveal>
          <Reveal delay={300}>
            <p className="mt-6 font-display italic text-2xl md:text-3xl text-white/85">
              Luxury Stay by the Ganges
            </p>
          </Reveal>
          <Reveal delay={450}>
            <p className="mt-6 max-w-xl mx-auto text-white/70 leading-relaxed text-balance">
              Experience peace, comfort and timeless hospitality in the eternal city of Varanasi.
            </p>
          </Reveal>
          <Reveal delay={600}>
            <div className="mt-12 flex flex-col sm:flex-row gap-4 items-center justify-center">
              <a href="#contact" className="luxe-btn">Book Your Stay</a>
              <a href="#rooms" className="luxe-btn-ghost">Explore Resort</a>
            </div>
          </Reveal>
        </div>
          ...
          <Reveal>
            <div className="relative">
              <div className="overflow-hidden">
                <img
                  src={aboutImg}
                  alt="Resort exterior with reflecting pool"
                  width={1280}
                  height={1600}
                  loading="lazy"
          ...
          <div>
            ...
            <Reveal delay={100}>
              <h2 className="mt-6 font-display text-4xl md:text-6xl leading-[1.05] text-balance">
                ...
                in <em className="not-italic text-gold">Varanasi</em>
              </h2>
            </Reveal>
            <Reveal delay={200}>
            ...
            <Reveal delay={250}>
              <p className="text-muted-foreground leading-relaxed text-lg max-w-lg">
                Located near the sacred Ganges, Shiv Rudraksh Resort blends modern comfort with
                spiritual serenity — offering unforgettable stays wrapped in elegant hospitality and
                quiet luxury.
              </p>
            </Reveal>
          ...
          <div className="text-center max-w-2xl mx-auto mb-20">
            ...
            <Reveal delay={100}>
              <h2 className="mt-6 font-display text-4xl md:text-6xl text-balance">
                Rooms Designed for <em className="not-italic text-gold">Quiet Luxury</em>
              </h2>
            </Reveal>
          ...
          <div className="columns-1 md:columns-2 lg:columns-3 gap-6 [column-fill:_balance]">
            {gallery.map((g, i) => (
              <Reveal key={i} delay={(i % 3) * 100} className="mb-6 break-inside-avoid">
                <div className="overflow-hidden hover-zoom group">
                  <img
                    src={g.src}
                    alt=""
                    loading="lazy"
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto py-24">
          ...
          <Reveal delay={450}>
            <div className="mt-12 flex flex-col sm:flex-row gap-4 justify-center items-center">
              <a href="tel:+919999999999" className="luxe-btn">Book Your Stay</a>
